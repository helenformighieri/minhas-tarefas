...
const initialState: TarefasState = {
    itens: [
        {
            id: 1,
            descricao: 'Estudar JavaScrip modulo 7',
        ...
        {
            id: 2,
            descricao: 'Estudar JavaScrip material de apoio',
        ...
        {
            id: 3,
            descricao: 'Estudar JavaScrip projeto',
            prioridade: enums.Prioridade.NORMAL,
            status: enums.Status.PENDENTE,
...
const tarefasSlice = createSlice({
    ...
    reducers: {
        ...
        editar: (state, action: PayloadAction<Tarefa>) =>{
            let indexDaTarefa = state.itens.findIndex(t => t.id === action.payload.id)
